...
async def get_description(message: Message, state: FSMContext):
    ...
    await message.answer("Прикрепите фото проблемы или нажмите кнопку:", reply_markup=kb)
...
async def get_photo(message: Message, state: FSMContext):
    ...
    await message.answer("✅ Спасибо! Заявка отправлена и сохранена в «Мои заявки».", reply_markup=main_menu)
    await state.clear()
